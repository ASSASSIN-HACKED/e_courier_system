	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="http://localhost/dbms%20j%20component/foreword.php">Foreword</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="http://localhost/dbms%20j%20component/">About</a>
...
<div class="jumbotron" id="about">
        <div class="container-fluid padding">
            <div class="row welcome text-center">
                <div class="col-12">
                    <h2 class="display-4">FOREWORD</h2><br>
										<h5 class="jumbotron">Presiding in front of you is our master-Shounak</h5>
                    <img src="images/author.jpeg" class="center" width="500" height="500">
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
			...
			<p class="lead">
								...
								To all our viewers it is indeed a privilege to have you among us.
                We have grown incrementally in the last few years. I am from Mumbai, Maharashtra and find a software of such nature of immense need.
                Happy journey.
            </p>
		</div>
  </div>
