					...
					<table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
						<tbody>
							<tr class="BoldRED" bgcolor="#FFFFFF" style="height:20px;">
								...
								<td class="newtext" bgcolor="#EDEDED" width="10%">shipment id </td>
								<td class="newtext" bgcolor="#EDEDED" width="7%">time</td>
								<td class="newtext" bgcolor="#EDEDED" width="11%">group no.</td>
								<td class="newtext" bgcolor="#EDEDED" width="11%">Present city </td>
								<td class="newtext" bgcolor="#EDEDED" width="9%">Status</td>
                <td class="newtext" bgcolor="#EDEDED" width="9%">Comments</td>
							</tr>
							<?php
							...
							while ($data = dbFetchAssoc($result)) {
								...
								<tr onMouseOver="this.bgColor='gold';" onMouseOut="this.bgColor='#FFFFFF';" bgcolor="#FFFFFF">
									...
									<td class="gentxt" align="center">
										<a href="edit-shipment.php?shipment_id=<?php echo $shipment_id; ?>">
                    
                    	<img src="images/edit_icon.gif" border="0" height="20" width="20"></a>
									</td>

									<td class="gentxt"><?php echo $shipment_id; ?></td>
									<td class="gentxt"><?php echo $time_of_booking; ?></td>
									<td class="gentxt"><?php echo $group_no; ?></td>
									<td class="gentxt"><?php echo $present_city; ?> </td>
									<td class="gentxt"><?php echo $status; ?></td>
                  <td class="gentxt"><?php echo $comments; ?></td>
                </tr>
							<?php
							} //while
							?>
