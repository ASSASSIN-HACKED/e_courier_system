	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item active">
					<a class="nav-link" href="foreword.php">Foreword</a>
				</li>
				<li class="nav-item">
...
<div class="jumbotron" id="about">
        <div class="container-fluid padding">
            <div class="row welcome text-center">
                <div class="col-12">
                    <h2 class="display-4">About</h2><br>
										<h5 class="jumbotron">Presenting our formula:- Mail + Time + Delivery = trust !</h5>
		...
		<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
			...
			<p class="lead">
								We recognize the trust you place in us when we deliver to your doorstep, shipping dock or place of business. That’s why we want to keep you informed on the actions we are taking to keep you – and our team members – safe amidst the COVID-19 outbreak.<br>
