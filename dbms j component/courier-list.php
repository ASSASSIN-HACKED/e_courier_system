...
<table border="0" align="center" width="80%">
    ...
    <tr>
      <td class="LargeBlue" bgcolor="#FFFFFF" align="left"><div class="Partext1" align="center"><strong>View All courier Details </strong></div></td>
    </tr>
  </tbody></table>
  ...
  <table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF" style="height:20px;">
      <td class="newtext" bgcolor="#EDEDED" width="20%">ITEM ID </td>
      <td class="newtext" bgcolor="#EDEDED" width="20%">CUSTOMER ID</td>
	  <td class="newtext" bgcolor="#EDEDED" width="10%">ADDRESS TO BE SENT</td>
      <td class="newtext" bgcolor="#EDEDED" width="15%">STREET</td>
      <td class="newtext" bgcolor="#EDEDED" width="20%">QUANTITY OF ITEMS</td>
      <td class="newtext" bgcolor="#EDEDED" width="15%">WEIGHT(in kg)</td>
      <td class="newtext" bgcolor="#EDEDED" width="15%">TYPE</td>
      <td class="newtext" bgcolor="#EDEDED" width="15%">BOOKMODE</td>
    </tr>
	<?php
	...
	?>
      ...
      <td class="gentxt"><?php echo $item_id; ?></td>
      <td class="gentxt"><?php echo $cust_id; ?></td>
      <td class="gentxt"><?php echo $addresstobesent; ?></td>
      <td class="gentxt"><?php echo $street; ?></td>
      <td class="gentxt"><?php echo $quantityofitems; ?></td>
	    <td class="gentxt"><?php echo $weightinkg; ?></td>
      <td class="gentxt"><?php echo $type; ?></td>
      <td class="gentxt"><?php echo $bookmode; ?></td>
                ...
                <div align="center">
                  <table cellpadding="4" cellspacing="0" align="center" width="70%">
                    ...
                    <tbody>
                      ...
                      <tr bgcolor="EFEFEF">
                        <td valign="top" class="alert alert-primary"><a href="admin.php">Go back<br />
                        </td>
                      </tr>
                      <tr bgcolor="EFEFEF">
