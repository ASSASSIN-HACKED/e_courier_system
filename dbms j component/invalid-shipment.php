                  ...
                  <div align="center">
                    <table cellpadding="4" cellspacing="0" align="center" width="70%">
                      ...
                      <tbody>
                        ...
                        <tr bgcolor="EFEFEF">
                          <td valign="top" class="alert alert-primary">Shipment id is already added. Please go <a href="add-shipment.php">back.<br />
                          </td>
                        </tr>
                        <tr bgcolor="EFEFEF">
    ...
    <div class="container-fluid padding">
      <div class="row text-center">
        ...
        <div class="col-md-4">
          ...
          <h5>Service Area</h5>
          <hr class="light">
          <p>Mumbai, Maharashtra, 00000</p>
          <p>Vellore, Tamil Nadu, 00000</p>
          <p>Thane, Maharashtra, 00000</p>
          <p>City, State, 00000</p>
        </div>
      </div>
    </div>
