...
if (isset($_POST['txtusername'])) {
  $error = checkUser($_POST['txtusername'], $_POST['txtpassword'], $_POST['id']);
} //if

require_once('database.php');
$sql = "SELECT id
		FROM registered_logins";
$result = dbQuery($sql);
                                                  ...
                                                  <td>
                                                    <table bgcolor="#FFFFFF" border="0" cellpadding="3" cellspacing="1" width="100%">
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                          <td>&nbsp;&nbsp;&nbsp;&nbsp;<font style="font-size:20px;">ID</font>
                                                          </td>
                                                          <td>:</td>
                                                          <td>
                                                            <select name="id" class="btn btn-light dropdown-toggle">
                                                              <?php
