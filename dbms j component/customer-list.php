...
<table border="0" align="center" width="80%">
    ...
    <tr>
      <td class="LargeBlue" bgcolor="#FFFFFF" align="left"><div class="Partext1" align="center"><strong>View All Customer Details </strong></div></td>
    </tr>
  </tbody></table>
  ...
  <table class="blackbox" border="0" cellpadding="1" cellspacing="1" align="center" width="95%">
    <tbody><tr class="BoldRED" bgcolor="#FFFFFF" style="height:20px;">
      ...
      <td class="newtext" bgcolor="#EDEDED" width="20%">PIN</td>
	  <td class="newtext" bgcolor="#EDEDED" width="10%">STREET</td>
      <td class="newtext" bgcolor="#EDEDED" width="15%">Phone Numner</td>
      <td class="newtext" bgcolor="#EDEDED" width="20%">STAFF ID</td>
    </tr>
	<?php
	...
	?>
      ...
      <td class="gentxt"><?php echo $custid; ?></td>
      <td class="gentxt"><?php echo $pin; ?></td>
      <td class="gentxt"><?php echo $street; ?></td>
      <td class="gentxt"><?php echo $phno; ?></td>
      <td class="gentxt"><?php echo $staff_id; ?></td>
